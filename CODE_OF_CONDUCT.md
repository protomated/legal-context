...
* Understanding the security implications of handling legal documents
* Ensuring that all code changes maintain the secure boundary promised by LegalContext
...
reported to the project team at [dele@protomated.com](mailto:ask@protomated.com).
